...
```{r aws result points, fig.height=10, fig.width=10, echo = FALSE}
...
```{r aws result line, fig.height=10, fig.width=10, echo = FALSE}
...
#AWS results in line plot
```{r aws result line 2, fig.height=10, fig.width=10, echo = FALSE}
